...
3. Flash INAV 7.1 **WITHOUT** _Full Chip Erase_ option
4. Done
...
Tailsitter builds are now natively supported to allow proper Board Oriantation switching during transition. [Details](https://github.com/iNavFlight/inav/pull/9347)
