...
To keep these settings when importing a `diff`. You will need to move them from the `# master` section to `battery profile 1` and any other battery profiles you use.  
