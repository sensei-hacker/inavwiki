...
| [osd_pan_servo_range_decidegrees](https://github.com/iNavFlight/inav/blob/master/docs/Settings.md#osd_pan_servo_range_decadegrees)| Replaces the name of the old `osd_pan_servo_pwm2centideg`|
