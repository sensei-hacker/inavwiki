...
| [osd_pan_servo_range_decadegrees](https://github.com/iNavFlight/inav/blob/master/docs/Settings.md#osd_pan_servo_range_decadegrees)| Replaces the name of the old `osd_pan_servo_pwm2centideg`|
...
| [transition_pid_mmix_multiplier_roll](transition_pid_mmix_multiplier_roll)| intended to solve roll/yaw coupling oscillation in transtion mode on tilting rotor VTOL|
...
| [mixer_control_profile_linking](https://github.com/iNavFlight/inav/blob/master/docs/Settings.md#mixer_control_profile_linking ) | Renames `mixer_pid_profile_linking` |
