...
| `telemetry_halfduplex` | **Cli.md and Telemetry.md  UPDATE** Replaces `telemetry_uart_unidir` |
...
| `rpm_dterm_min_hz` | |
| `rpm_dterm_q` | | 
| `telemetry_uart_unidir` | **Cli.md and Telemetry.md UPDATE** Replaced by `telemetry_halfduplex` |
