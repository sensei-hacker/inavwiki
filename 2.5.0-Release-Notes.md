...
* **JUMP**: Defines a 'jump' another waypoint number, allowing mission loops (back) and forward jumps. The number of jumps may also be defined.
...
See the [navigation messages wiki page](https://github.com/iNavFlight/inav/wiki/MSP-Navigation-Messages) for more information and an annotated example.
