...
| `nav_fw_control_smoothness` | Controls smoothness of navigation control (0-9). 0 gives legacy behaviour, non-zero value give increasing smoothness. Do not assume high values will automagically work for your aircraft. |
