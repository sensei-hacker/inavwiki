...
| `motor_direction_inverted` | **Cli.md UPDATE needed** Boolean ON / OFF, replaces `yaw_motor_direction` |
...
| `telemetry_halfduplex` | **Cli.md and Telemetry.md UPDATE needed** Replaces `telemetry_uart_unidir` |
...
| `rpm_dterm_min_hz` | |
| `rpm_dterm_q` | | 
| `telemetry_uart_unidir` | **Cli.md and Telemetry.md UPDATE needed** Replaced by `telemetry_halfduplex` |
| `yaw_motor_direction` | **Cli.md UPDATE needed** Replaced by `motor_direction_inverted` | 
