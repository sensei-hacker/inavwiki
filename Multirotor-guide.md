...
* Ensure that your motors are mapped correctly because it is not possible to remap motors after installation: Verify that motors #4 and #2 are in the front left and right positions, and #3 and #1 are in the rear left and right positions, respectively.
