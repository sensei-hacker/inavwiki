...
| `failsafe_min_distance_procedure` | What failsafe procedure to initiate in Stage 2 when craft is closer to home than failsafe_min_distance. See Failsafe documentation. |
