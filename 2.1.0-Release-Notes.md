...
1. INAV 2.1 is the last release of INAV that fully supports **Omnibus F3** boards. Due to the lack of flash and RAM, future versions of INAV will either remove functions on Omnibus F3 or not support this boards at all. Omnibus F3 is strongly discouraged for new builds and existing builds should be upgraded to F7 boards
