...
3. Flash INAV 2.1.0 enabling **full chip erase** . Now you FC should run INAV 2.1.0 Connect again and check firmware version.
...
4. Flash INAV 2.1.0 enabling **full chip erase** . Now you FC should run INAV 2.0. Connect again and check firmware version.
