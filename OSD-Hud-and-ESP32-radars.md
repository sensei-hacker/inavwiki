...
**Radar detail nearest** : To display an extra bar of informations at the bottom of the hud area for the closest radar aircraft found. Shows : Relative altitude (meters of feet) with an up or down arrow to indicate if above or below, speed ( in m/s or f/s), and absolute heading (in °, 0 is north, 90 is east, 180 is south, 270 is west). 
