...
4. Run your INAV 5.x _diff_ through [this tool](https://www.mrd-rc.com/iNav/INAV-6.0-CLI-Update.php). It will update some of the changed CLI parameters _(See these release notes)_.
...
6. You should be ready, explore new 6.0 features, and enjoy!
...
However, in your diff, you may have the parameter `imu_inertia_comp_method`. If you are using fixed wing, you should update this to the new _ahrs_ parameter name. For fixed wing, use the CLI command

```
set ahrs_inertia_comp_method = ADAPTIVE
```

For all other platforms, use the default value of `VELNED`.
