...
---------------------------
### When Updating from INAV 5.1 or older, it is safe to ignore errors from your diff file related to imu_acc_ignore_rate, imu_acc_ignore_slope, imu_dcm_kp, imu_dcm_kp_map, imu_dcm_ki_mag. These variables behave differently in 6.0 and have been renamed, so you should try the default values of the new ones first.
