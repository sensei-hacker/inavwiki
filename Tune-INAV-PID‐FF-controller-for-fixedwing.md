...
### LEVEL controller:  
* If you're unhappy with the strength ANGLE based modes return to level after the stick is released. You can adjust the P-gain of the LEVEL controller via `fw_p_level`. The default value of 20 is optimal. However reducing it can't provide a smoother feel.  
