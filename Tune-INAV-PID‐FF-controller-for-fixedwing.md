...
The FF-gain should do most of the work of turning the airplane, if tuned correctly. Which leaves Proportional, Integral and Derivative to make up for slight target error and drift caused by turbulence.  

Tuning of the Rates and Feedforwards can be done more easily via [AutoTune](https://github.com/iNavFlight/inav/wiki/Modes#autotune-fw), provided its done correctly.   
...
Do hard rolls, hard loops and one 360° yaw turn. Apply **full stick** deflection on all these maneuvers.
...
* If the airplane drifts to one side or up/down slightly. Increasing the I-gain on that given axis, can reduce the effect.   
Allowing I-gain to do more of the work than P-gain, _after_ Feedforward. Can actually make the Roll axis response smoother from an FPV perspective, than fighting a loosing battle, by applying too much P-gain, in hopes of removing roll axis wobbles.  
...
* **LEVEL controller** - If you're unhappy with the strength ANGLE based modes return to level, after the sticks are released. You can adjust the P-gain of the LEVEL controller via `fw_p_level`. The default value of 20 is optimal. Increasing this value beyond 30 on a fixedwing; generally make the corresponding axis more jittery, rather than adding more Level holding strength.  
...
The I-term Lock aims to solve the I-term accumulation and bounce-back on Fixedwing platforms, as the sticks are quickly release back to center, when the airplane still has angular momentum on that axis. 
