...
P-term will never be able to fully correct for roll axis instability, due to processing and SERVO reaction lag. It can often be a case of what you prefer. Faster jittering or Slow wallowing movement on the roll axis.  
...
* N**ote:** It's normal to see reduced servo throw's when reducing rates at this point. If you have full servo throw at this stages you would likely overshoot the target deg/s as well, leaving the P-term to do the rest.
