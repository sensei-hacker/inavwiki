...
Also be aware that some of our flight controllers can cause interference with the GPS, causing low satellite counts, or even no satellites at all. Keep the GPS as far away from the flight controller as possible. Either shield your GPS, or flight controller from any equipment that could cause interference.
...
* Old version of INAV configurator: verify that you're on the latest version see [link](https://chrome.google.com/webstore/detail/inav-configurator/fmaidjmgkdkpafmbnmigkpdnpdhopgel). If it fails to update, simply uninstall and re-install the configurator.
...
If you are using your FC onboard mag, try to place the FC as far away as possible from the parts causing magnetic interference e.g. mounting it on/under the top plate on small racers.
...
**Checklist if you're having an issue:**
