...
M10 GPS units will now default to 10Hz, like M8 units and a new cli setting has been added to allow overriding the update rate (`gps_ublox_nav_hz`) if you would like to fall back to 5Hz or bump it up to the limits of what is supported by your `UBLOX7` GPS module. 
