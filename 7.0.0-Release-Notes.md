...
Bear in mind:
* In some rare cases, output assignment might be different than in INAV 6. **This makes it even more important to remove your props and double check your outputs before you power you flight controller with batteries for the first time after applying your old settings or enabling outputs.**
