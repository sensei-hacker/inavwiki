...
Bear in mind:
* In some rare cases, output assignment might be different than in INAV 6. **Double check your outputs before you power you flight controller with batteries for the first time.**
