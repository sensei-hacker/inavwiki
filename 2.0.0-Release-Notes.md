...
* The `mid_rc` CLI variable has been removed, and the setting removed from the configurator. If necessary, the same effect can be achieved using `rxrange` settings.
